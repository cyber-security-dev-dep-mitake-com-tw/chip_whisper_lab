// Module 14: JTAG/SWD Attacks & RDP Bypass
...
export default function ModulePage({
  moduleId = "module-14-jtag-swd",
  title = "JTAG/SWD Attacks & RDP Bypass",
  learningObjectives = [
    "Understand the core concepts of JTAG/SWD interfaces",
  ...
  return (
    <div className="module-container">
      ...
      <section className="module-content">
        ...
        <p>
          This module covers JTAG/SWD interfaces, RDP bypass, debug port exploitation. You will learn fundamental concepts,
