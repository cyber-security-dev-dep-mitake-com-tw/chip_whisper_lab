...
export default function ModulePage({
  moduleId = "module-17-tee-microarch",
  title = "TEE & Microarchitecture Security",
  learningObjectives = [
    "Understand the core concepts of TrustZone",
  ...
  return (
    <div className="module-container">
      ...
      <section className="module-content">
        ...
        <p>
          This module covers TrustZone, SGX, PMP, microarchitectural security. You will learn fundamental concepts,
