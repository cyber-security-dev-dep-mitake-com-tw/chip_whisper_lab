...
export default function ModulePage({
  moduleId = "module-07-cw-lite-lab01",
  title = "CW-Lite Platform & Lab 01",
  learningObjectives = [
    "Understand the core concepts of Scope setup",
  ...
  return (
    <div className="module-container">
      ...
      <section className="module-content">
        ...
        <p>
          This module covers Scope setup, target configuration, signal capture. You will learn fundamental concepts,
