// Module 23: Cryo-CMOS & QPU Security
...
export default function ModulePage({
  moduleId = "module-23-cryo-cmos",
  title = "Cryo-CMOS & QPU Security",
  learningObjectives = [
    "Understand the core concepts of Cryogenic electronics",
  ...
  return (
    <div className="module-container">
      ...
      <section className="module-content">
        ...
        <p>
          This module covers Cryogenic electronics, QPU security, quantum computing hardware. You will learn fundamental concepts,
