...
export default function ModulePage({
  moduleId = "module-02-symmetric-hash",
  title = "Symmetric Crypto & Hash Functions",
  learningObjectives = [
    "Understand the core concepts of AES",
  ...
  return (
    <div className="module-container">
      ...
      <section className="module-content">
        ...
        <p>
          This module covers AES, SHA-2/3, symmetric primitives, hash functions. You will learn fundamental concepts,
