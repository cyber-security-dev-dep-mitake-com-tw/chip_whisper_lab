# Module 02: Theory - Symmetric Crypto & Hash Functions

## Core Concepts

### AES encryption algorithm and its modes of operation

Understanding the fundamental principles of AES encryption algorithm and its modes of operation is essential for:
- Analyzing system security properties
- Identifying potential vulnerabilities
- Implementing effective countermeasures
- Evaluating security certifications

### SHA-2 and SHA-3 hash function properties and applications

SHA-2 and SHA-3 hash function properties and applications provides the foundation for:
