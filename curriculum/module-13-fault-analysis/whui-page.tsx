// Module 13: Fault Analysis Models & Defenses
...
export default function ModulePage({
  moduleId = "module-13-fault-analysis",
  title = "Fault Analysis Models & Defenses",
  learningObjectives = [
    "Understand the core concepts of DFA models",
  ...
  return (
    <div className="module-container">
      ...
      <section className="module-content">
        ...
        <p>
          This module covers DFA models, lockstep defenses, fault attack countermeasures. You will learn fundamental concepts,
