# Module 03: Theory - Asymmetric & Post-Quantum Crypto

## Core Concepts

### Traditional asymmetric cryptography (RSA, ECC)

Understanding the fundamental principles of Traditional asymmetric cryptography (RSA, ECC) is essential for:
- Analyzing system security properties
- Identifying potential vulnerabilities
- Implementing effective countermeasures
- Evaluating security certifications

### Post-quantum cryptography fundamentals and NIST standards

Post-quantum cryptography fundamentals and NIST standards provides the foundation for:
