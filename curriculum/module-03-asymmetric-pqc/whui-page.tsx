// Module 03: Asymmetric & Post-Quantum Crypto
...
export default function ModulePage({
  moduleId = "module-03-asymmetric-pqc",
  title = "Asymmetric & Post-Quantum Crypto",
  learningObjectives = [
    "Understand the core concepts of RSA",
  ...
  return (
    <div className="module-container">
      ...
      <section className="module-content">
        ...
        <p>
          This module covers RSA, ECC, Kyber, Dilithium, post-quantum cryptography. You will learn fundamental concepts,
