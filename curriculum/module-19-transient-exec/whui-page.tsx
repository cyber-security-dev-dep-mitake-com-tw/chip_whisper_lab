...
export default function ModulePage({
  moduleId = "module-19-transient-exec",
  title = "Transient Execution",
  learningObjectives = [
    "Understand the core concepts of Spectre",
  ...
  return (
    <div className="module-container">
      ...
      <section className="module-content">
        ...
        <p>
          This module covers Spectre, Meltdown, Rowhammer, transient attacks. You will learn fundamental concepts,
