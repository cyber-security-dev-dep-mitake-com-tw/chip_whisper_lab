...
export default function ModulePage({
  moduleId = "module-05-secure-boot",
  title = "Secure Boot & Authentication",
  learningObjectives = [
    "Understand the core concepts of Measured boot",
  ...
  return (
    <div className="module-container">
      ...
      <section className="module-content">
        ...
        <p>
          This module covers Measured boot, secure boot chains, attack cases. You will learn fundamental concepts,
