...
export default function ModulePage({
  moduleId = "module-04-puf-trng",
  title = "PUF & TRNG",
  learningObjectives = [
    "Understand the core concepts of RO-PUF",
  ...
  return (
    <div className="module-container">
      ...
      <section className="module-content">
        ...
        <p>
          This module covers RO-PUF, Arbiter PUF, Ring Oscillator TRNG, entropy sources. You will learn fundamental concepts,
