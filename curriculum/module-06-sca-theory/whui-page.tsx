...
export default function ModulePage({
  moduleId = "module-06-sca-theory",
  title = "Side-Channel Analysis Theory",
  learningObjectives = [
    "Understand the core concepts of SPA",
  ...
  return (
    <div className="module-container">
      ...
      <section className="module-content">
        ...
        <p>
          This module covers SPA, DPA, CPA math, side-channel analysis fundamentals. You will learn fundamental concepts,
