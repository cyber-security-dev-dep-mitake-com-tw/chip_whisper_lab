...
export default function ModulePage({
  moduleId = "module-16-hw-trojans",
  title = "Hardware Trojans",
  learningObjectives = [
    "Understand the core concepts of Trust-Hub",
  ...
  return (
    <div className="module-container">
      ...
      <section className="module-content">
        ...
        <p>
          This module covers Trust-Hub, detection methods, counterfeit ICs. You will learn fundamental concepts,
