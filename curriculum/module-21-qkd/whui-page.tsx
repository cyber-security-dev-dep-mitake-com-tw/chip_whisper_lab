...
export default function ModulePage({
  moduleId = "module-21-qkd",
  title = "QKD Device Security",
  learningObjectives = [
    "Understand the core concepts of SPAD blinding",
  ...
  return (
    <div className="module-container">
      ...
      <section className="module-content">
        ...
        <p>
          This module covers SPAD blinding, timing side-channels, quantum key distribution. You will learn fundamental concepts,
