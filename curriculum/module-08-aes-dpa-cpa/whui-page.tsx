// Module 08: AES DPA/CPA Deep Dive
...
export default function ModulePage({
  moduleId = "module-08-aes-dpa-cpa",
  title = "AES DPA/CPA Deep Dive",
  learningObjectives = [
    "Understand the core concepts of Key recovery",
  ...
  return (
    <div className="module-container">
      ...
      <section className="module-content">
        ...
        <p>
          This module covers Key recovery, trace alignment, advanced attacks. You will learn fundamental concepts,
