// Module 18: Cache Side-Channel Attacks
...
export default function ModulePage({
  moduleId = "module-18-cache-sc",
  title = "Cache Side-Channel Attacks",
  learningObjectives = [
    "Understand the core concepts of Flush+Reload",
  ...
  return (
    <div className="module-container">
      ...
      <section className="module-content">
        ...
        <p>
          This module covers Flush+Reload, Prime+Probe, cache timing attacks. You will learn fundamental concepts,
