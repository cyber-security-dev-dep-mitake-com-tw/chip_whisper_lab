// Module 11: Fault Injection - Voltage & Clock Glitching
...
export default function ModulePage({
  moduleId = "module-11-fault-glitching",
  title = "Fault Injection - Voltage & Clock Glitching",
  learningObjectives = [
    "Understand the core concepts of Voltage glitching",
  ...
  return (
    <div className="module-container">
      ...
      <section className="module-content">
        ...
        <p>
          This module covers Voltage glitching, clock glitching, parameter manipulation. You will learn fundamental concepts,
