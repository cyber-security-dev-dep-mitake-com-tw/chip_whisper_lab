...
export default function ModulePage({
  moduleId = "module-10-countermeasures",
  title = "SCA Countermeasures",
  learningObjectives = [
    "Understand the core concepts of Masking",
  ...
  return (
    <div className="module-container">
      ...
      <section className="module-content">
        ...
        <p>
          This module covers Masking, hiding, shuffling, threshold implementations. You will learn fundamental concepts,
