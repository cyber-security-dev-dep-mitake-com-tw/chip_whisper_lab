// Module 20: PQC Hardware Acceleration + SCA/FIA on PQC
...
export default function ModulePage({
  moduleId = "module-20-pqc-hw",
  title = "PQC Hardware Acceleration + SCA/FIA on PQC",
  learningObjectives = [
    "Understand the core concepts of PQC acceleration",
  ...
  prerequisites = ["Module 03", "Module 09"]
}: ModuleProps) {
  return (
    <div className="module-container">
      ...
      <section className="module-content">
        ...
        <p>
          This module covers PQC acceleration, SCA/FIA on PQC implementations. You will learn fundamental concepts,
