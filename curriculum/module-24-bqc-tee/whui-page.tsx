// Module 24: Blind Quantum Computing + TEE
...
export default function ModulePage({
  moduleId = "module-24-bqc-tee",
  title = "Blind Quantum Computing + TEE",
  learningObjectives = [
    "Understand the core concepts of Blind quantum computing",
  ...
  prerequisites = ["Module 17", "Module 22"]
}: ModuleProps) {
  return (
    <div className="module-container">
      ...
      <section className="module-content">
        ...
        <p>
          This module covers Blind quantum computing, TEE integration, quantum-resistant systems. You will learn fundamental concepts,
